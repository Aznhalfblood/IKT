...
new Point(360, 90), new Point(300, 80),
        ...
        Font fn = new Font("Arial", 8, FontStyle.Bold);
        ...
        nachalo_x, konec_y);
        // Задаем значения экспериментов
        string[] year = new string[8] { "1", "2", "3", "4", "5", "6", "7", "8"};
        // Задаем значения элементов массива экспериментов
        int[] value = new int[8] { 52, 625, 886, 560, 134, 1118, 1118, 1378 };
